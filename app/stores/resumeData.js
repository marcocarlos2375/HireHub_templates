  ...
  state: () => ({
    ...
    experience: [
      ...
      },
      {
        ...
        start_date: 'Jun 2022',
        end_date: 'Present',
        description: '<p><strong>Senior Software Engineer</strong> working on Google Cloud Platform’s AI and machine learning services.</p><ul><li>Led the development of a new BigQuery ML feature that accelerated training speed by 40%.</li><li>Partnered with cross-functional teams to design and deliver RESTful APIs for deploying ML models.</li><li>Partnered with cross-functional teams to design and deliver RESTful APIs for deploying ML models.</li><li>Partnered with cross-functional teams to design and deliver RESTful APIs for deploying ML models.</li><li>Partnered with cross-functional teams to design and deliver RESTful APIs for deploying ML models.</li><li>Partnered with cross-functional teams to design and deliver RESTful APIs for deploying ML models.</li><li>Partnered with cross-functional teams to design and deliver RESTful APIs for deploying ML models.</li><li>Partnered with cross-functional teams to design and deliver RESTful APIs for deploying ML models.</li><li>Partnered with cross-functional teams to design and deliver RESTful APIs for deploying ML models.</li><li>Partnered with cross-functional teams to design and deliver RESTful APIs for deploying ML models.</li><li>Partnered with cross-functional teams to design and deliver RESTful APIs for deploying ML models.</li><li>Partnered with cross-functional teams to design and deliver RESTful APIs for deploying ML models.</li><li>Partnered with cross-functional teams to design and deliver RESTful APIs for deploying ML models.</li><li>Engineered scalable backend systems ensuring high availability and performance.</li><li>Improved reliability through automation, monitoring, and self-healing infrastructure.</li><li>Mentored 5 junior engineers, provided guidance, and ran technical interviews.</li><li>Implemented CI/CD pipelines that reduced deployment time by 60% and increased release frequency.</li></ul>'
      },
      {
        id: 3,
        job_title: 'Software Engineer',
