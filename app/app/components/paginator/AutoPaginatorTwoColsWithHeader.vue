<!-- AutoPaginatorTwoColsWithHeader.vue -->
<template>
    <div class="auto-paginator-2c" :style="componentStyle" role="region" aria-label="Paginated document">
      ...
      <div
        ...
        :class="headerClass"
        :style="{ width: pageWidth - 2*pagePadding + 'px' }"
      />
      <div
        ref="measurerLeft"
  ...
  export default {
    name: 'AutoPaginatorTwoColsWithHeader',
    ...
    computed: {
      ...
      columnMaxHeight() {
        return Math.max(0, this.pageHeight - 2 * this.pagePadding - this.headerHeight - this.fudgePx);
      },
    ...
    methods: {
      ...
      measureHeaderHeight() {
        ...
        if (!h) return;
        // No need to add headerGap since we're using fixed headerHeight
            ...
            const pageStyles = `
              <style>
                ...
                .page-header {
                  ...
                  padding-top: ${this.headerPaddingTop}px;
                  padding-right: ${this.headerPaddingRight}px;
                  padding-bottom: ${this.headerPaddingBottom}px;
                  padding-left: ${this.headerPaddingLeft}px;
